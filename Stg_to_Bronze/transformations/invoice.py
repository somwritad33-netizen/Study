...
# CONFIG
# =========================================================
invoice_path = '/Volumes/dev_p2p/staging/raw_data/invoice'  # <-- update to your PDF folder
...
# =========================================================
@dlt.table(
    name='bronze_invoice_pdf',
    comment='Raw invoice PDF files ingested via Auto Loader, parsed with ai_parse_document',
